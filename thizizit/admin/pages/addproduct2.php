...
if(isset($_POST['reghotel'])){
    ...
    $query = mysqli_query($connect, "INSERT INTO rooms(hotel_id, room_name, description, price, roomamenities, room_img) VALUES ('$hotelid','$productname','$description','$price','$amenities','$target_file')");
