...
if(isset($_POST['search'])){
  ...
  $searchQuery = mysqli_query($connect, "SELECT hr.*, r.* FROM hotel_registration as hr left join rooms as r on hr.hotel_id = r.hotel_id where hr.hotel_name like '%".$search."%' or hr.address like '%".$search."%' or hr.business_type like '%".$search."%' or r.room_name like '%".$search."%'");
            ...
            <span class="rm_left pull-right">Hurry! 
              ...
              <div class="rm_amenities_cont"> 
                ...
                <div class="row margin-lr-0 pull-left rm_price_cont"> 
                  ...
                  <a cat_rm_check_in="2018-11-08" cat_rm_check_out="2018-11-15" href="resultpage2.php" rm_product_id="8" cat_rm_book_nm_days="7" data-id-product-attribute="0" data-id-product="8" class="btn btn-default button button-medium ajax_add_to_cart_button pull-right"><span>Book Now</span></a>
                <div class="btn-group" data-toggle="buttons-radio">
