    ...
    <body>
         ...
         <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="page-header">File Maintenance > Activities</h5>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
...
$view_query = mysqli_query($connect, "SELECT * FROM activities");
  ...
  <form method="post" id="user_form" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-body">
     <label id="label_image">Select Activity Image</label><br />
     <input type="file" name="user_image" id="user_image" />
     <span id="user_uploaded_image"></span>
     <br />
     <br />
     <label id="label_lastname">Enter Activity</label>
