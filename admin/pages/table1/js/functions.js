 ...
 $(document).on('click', '.update', function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    $("#text_business").prop('disabled', false); 
    $("#text_business").css({"border": "1px solid #ccc"});
    $('#text_business').val(data.text_business);

    $("#text_hotel").prop('disabled', false); 
    $("#text_hotel").css({"border": "1px solid #ccc"});
    $('#text_hotel').val(data.text_hotel);

    $("#text_description").prop('disabled', false); 
    $("#text_description").css({"border": "1px solid #ccc"});
    $('#text_description').val(data.text_description);

    $("#text_address").prop('disabled', false); 
    $("#text_address").css({"border": "1px solid #ccc"});
    $('#text_address').val(data.text_address);

    $("#text_email").prop('disabled', false); 
    $("#text_email").css({"border": "1px solid #ccc"});
    $('#text_email').val(data.text_email);

    $("#text_number").prop('disabled', false); 
    $("#text_number").css({"border": "1px solid #ccc"});
    $('#text_number').val(data.text_number);
