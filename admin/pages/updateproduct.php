...
<input type = "hidden" name="user_id" value=<?php echo $user_id ?>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number"  id="bed" class="form-control input-sm" min="1" max="5" name="beds" value ="<?php echo $db_beds; ?>"  placeholder="No. beds" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number"  id="adult" class="form-control input-sm" min="1" max="30" value ="<?php echo $db_maxadult; ?>" name="adult" placeholder="No. adults" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number"  id="bed" class="form-control input-sm" min="1" max="30" name="child" value ="<?php echo $db_maxchild; ?>" placeholder="No. child" required>
                                    </div>
                                </div>
