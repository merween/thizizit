    ...
    <body>
         ...
         <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="page-header">File Maintenance > Amenities</h5>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
...
$view_query = mysqli_query($connect, "SELECT * FROM amenities");


while ($row = mysqli_fetch_assoc($view_query)){
$id = $row['id'];
$activity = $row['amenities_name'];
$activity_id = $row['amenities_id'];
$image = $row['image'];

echo "<tr>
    
    <td><img src='amenities_image/".$image."' style='width:64px;height:64px'></td>
    <td>$activity</td>
    <td>
  ...
  <form method="post" id="user_form" enctype="multipart/form-data">
   <div class="modal-content">
    ...
    <div class="modal-body">
     <label id="label_image">Select Amenities Image</label><br />
     <input type="file" name="user_image" id="user_image" />
     <span id="user_uploaded_image"></span>
     <br />
     <br />
     <label id="label_lastname">Enter Amenities</label>
...
$(document).ready(function(){
 $('#add_button').click(function(){
  $('#user_form')[0].reset();
  $('.modal-title').text("Add Amenities");
  $('#action').val("Add");
  $('#operation').val("Add");
