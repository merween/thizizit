    ...
    <div id="columns" class="container">
                ...
                <div id="center_column" class="center_column col-xs-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <form action="register.php" method="post" id="create-account_form" class="box >
        ...
        <div class="form_content clearfix">
            ...
            <div class="form-group"> 
                ...
                <button class="btn button button-medium" type="submit" id="SubmitCreate" name="SubmitCreate" ><a href="register.php"> <span> <i class="icon-user left"></i> Create an account </span></a> </button> 
